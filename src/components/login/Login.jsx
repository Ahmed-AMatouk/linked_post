...
export default function Login() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit(submit)} className="bg-white m-8 mx-auto max-w-lg w-full rounded-2xl p-8 shadow ">
            ...
            <p className='text-center'>Don't have an account?  <Link className='text-blue-500' to={"/register/signup"}>Sign up</Link> </p>
            ...
            </div>
            {
              ...
              :
                <button type="submit" className=" rounded-xl pointer w-full py-3 bg-linear-to-r from-blue-600 to-blue-400 border-none text-white font-bold"><span>Sign
                  in </span><svg data-prefix="fas" data-icon="arrow-right" className="svg-inline--fa fa-arrow-right" role="img" viewBox="0 0 512 512" aria-hidden="true">
